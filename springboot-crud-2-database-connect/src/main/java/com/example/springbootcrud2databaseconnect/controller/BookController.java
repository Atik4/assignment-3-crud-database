...
import com.example.springbootcrud2databaseconnect.exception.BookNotFoundException;
...
public class BookController 
{
	...
	{
		return bookService.getBookById(id).orElseThrow(()-> new BookNotFoundException(id));
	}
